...
<div id="Deals">
    <table border="1" bgcolor="">
        ...
        <tr>
            <td><img src="http://pngimg.com/upload/tablet_PNG8593.png" style="height: 400px; width: 400px;"><p>Sony Tablet &nbsp;<del>$500.00</del> &nbsp;$300.00</p><br><p><center></center><button type="button" class="btn btn-info">Info</button> <button type="button" class="btn btn-success">Add to Cart</button></p></center></td>
